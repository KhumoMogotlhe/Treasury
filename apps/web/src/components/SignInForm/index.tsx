  ...
  return (
    <S.Wrapper>
      ...
      <S.Card>
        ...
        <S.CardSubtitle>Sign in to your account to continue.</S.CardSubtitle>
        ...
        <S.Divider>
          <S.DividerLine />
          <S.DividerText>or sign in with email</S.DividerText>
          <S.DividerLine />
        </S.Divider>

        <S.Form onSubmit={handleCredentials}>
        ...
        <S.Footer>
          ...
          <Link href="/sign-up" passHref legacyBehavior>
            <S.FooterLink>Create one</S.FooterLink>
          </Link>
        </S.Footer>
      </S.Card>
    </S.Wrapper>
